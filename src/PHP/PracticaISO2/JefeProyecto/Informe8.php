...
//        $proyecto = 5; //esta variable tiene que se de sesion
    ...
    <body>
        ...
        <div id="blogtitle">
            <div id="small">Jefe de proyecto (<u><?php echo $_SESSION['login'] ?></u>) - Informes - Actividades pendientes</div>
                                    ...
                                    <table><tr><td>
                                        ...
                                        <tr><td>
                                                <div><h3>Condiciones:</h3>
                                                    ...
                                                    <p><img src= "../images/LICondiciones.jpg" alt="#" border="0" style="width: auto; height: 12px;"/>&nbsp;&nbsp;Solo podr&aacute; ver actividades hasta la fecha de inicio estimada
